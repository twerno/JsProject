...
namespace Def {
    ...
    //        buildEnchantments: (trigger: Trigger, targets: Permanent[], gameCtx: HsGameCtx) => Enchantment[]
    //    }


    export function Aura<T extends Permanent>( param: any ): IDefTrigger {
        ...
        //
        //                // usuwamy zarejestrowane enchanmenty
        ...
        //
        //                // rejestrujemy nowe
        //                newEnchantments = param.buildEnchantments(trigger, targets, gameCtx);
