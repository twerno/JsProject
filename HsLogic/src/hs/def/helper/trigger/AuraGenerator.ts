...
namespace Def {
    ...
    //export interface IMinionOriginAuraGenerator {
    //    ctx?: AuraGeneratorContext,
    //    auraType: AURA_TYPE,
    //    targets: ( context: HsGameCtx ),
    //    rebuildAura: ( trigger: Trigger, event: ActionEvent, context: HsGameCtx ) => Enchantment[]
    //}


    //export function MinionOriginAuraGenerator( param: IMinionOriginAuraGenerator ): IDefTrigger {
    //    return {
