...
namespace HSLogic {
    ...
    export interface MakeAChoiceAtRandomParam<T extends HsEntity> extends ChooseActionParam<T> {
     ...
     *
 	 */
    export class MakeAChoiceAtRandom<T extends HsEntity, P extends MakeAChoiceAtRandomParam<T>> extends ChooseAction<P> {
