        ...
        resolve(_this_: CancellableActionExternalWrapper<T, P>, param: T): PromiseOfActions<T> {
            return new Promise<IAction<T>[]>(
                ...
                (resolve, reject): void => {
                    ...
                    let onBeforeEvent: ActionEvent<P, T> = _this_.mainAction.buildOnBeforeEvent(eventParam);
            ...
            return new Promise<IAction<T>[]>(
                ...
                (resolve, reject): void => {
                    ...
                    if (!_this_.mainAction.doCancelOnAfterEvent(eventParam)) {
                        let onAfterEvent: ActionEvent<P, T> = _this_.mainAction.buildOnAfterEvent(eventParam);
