...
namespace jsLogic {
    ...
    export class ActionBuilder {
        ...
        dispatch<T extends IHasHandlersAndBuilder, P extends IEventParam<T>>(event: ActionEvent<P, T>): DispatchEventAction<P, T> {
            return new DispatchEventAction<P, T>(event);
        }
